        ...
        <div
          ...
          >
            ...
            <div 
                ...
                :class="size === 'sm' ? 'h-6 w-6 p-1' : 'h-8 w-8 p-1.5'"
            >
                <Icon 
                    v-if="techIcons[item]" 
                    :name="techIcons[item]" 
                ...
                />
                <Icon v-else name="mage:box-3d" :class="size === 'sm' ? 'text-sm' : 'text-xl'" class="text-neutral-400" />
            </div>
            
            <span class="font-bold tracking-tight text-neutral-700 transition-colors group-hover:text-neutral-900 dark:text-neutral-300 dark:group-hover:text-white" :class="size === 'sm' ? 'text-[11px]' : 'text-sm'">
                {{ item }}
            </span>
          </div>
