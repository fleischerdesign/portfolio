...
function getColorClass(count: number) {
  ...
  const colors = [
    ...
    'dark:fill-secondary-300 fill-secondary-700 hover:scale-125 hover:drop-shadow-glow transition origin-center',
    'dark:fill-secondary-400 fill-secondary-600 hover:scale-125 hover:drop-shadow-glow transition origin-center',
    'dark:fill-secondary-500 fill-secondary-500 hover:scale-125 hover:drop-shadow-glow transition origin-center',
    'dark:fill-secondary-600 fill-secondary-400 hover:scale-125 hover:drop-shadow-glow transition origin-center',
  ]
  return colors[level]
}
