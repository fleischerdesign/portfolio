      ...
      <UiCardContainer class="flex-col items-start gap-4 p-10 md:flex-row md:items-center md:justify-between">
        <div class="flex flex-col gap-3">
            <div class="flex items-center gap-3">
                ...
                <h3 class="text-2xl font-bold tracking-tight text-primary-900 dark:text-white">{{ $t("home.overview.searching.title") }}</h3>
            </div>
            <p class="max-w-2xl text-lg leading-relaxed text-primary-600 dark:text-primary-300">{{ $t("home.overview.searching.subtitle") }}</p>
        </div>
