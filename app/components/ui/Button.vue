...
const baseClasses = 'shadow-sm rounded-lg py-3 px-5 flex justify-center gap-3 hover:shadow-inner transition cursor-pointer';
...
const variantClasses = {
    ...
    secondary: 'bg-secondary-400 text-neutral-900 font-medium hover:bg-secondary-300 hover:!shadow-glow active:bg-secondary-500 active:!shadow-none',
};
