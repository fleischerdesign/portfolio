...
<template>
  <div class="pdf-resume-container font-sans text-neutral-900 print:bg-neutral-100">
    ...
    <div class="main-content-pages relative flex h-[371mm] flex-col overflow-hidden px-[25mm] pb-[25mm] pt-[25mm]">
      ...
      <ResumeFooter :current-page="1" :total-pages="3 + projects.slice(0,3).length" class="absolute bottom-10 left-20 right-20" />
    </div>
    ...
    <div class="main-content-pages relative flex h-[371mm] flex-col gap-6 overflow-hidden p-[25mm]">
      ...
      <ResumeFooter :current-page="2" :total-pages="3 + projects.slice(0,3).length" class="absolute bottom-10 left-20 right-20" />
    </div>
    ...
    <div class="main-content-pages relative flex h-[371mm] break-inside-avoid-page flex-col gap-6 overflow-hidden p-[25mm]">
      ...
      <ResumeFooter :current-page="3" :total-pages="3 + projects.slice(0,3).length" class="absolute bottom-10 left-20 right-20" />
    </div>

    <!-- ==================== PAGE 5+: PROJECT DETAILS ==================== -->
    <div v-for="(project, index) in projects.slice(0,3)" :key="project.slug" class="main-content-pages relative flex h-[371mm] break-inside-avoid-page flex-col gap-6 overflow-hidden p-[25mm]">
      ...
      <ResumeFooter :current-page="4 + index" :total-pages="3 + projects.slice(0,3).length" class="absolute bottom-10 left-20 right-20" />
    </div>
